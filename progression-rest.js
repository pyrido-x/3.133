...
var ProgressionManager = (function(){
    ...
    var SHOP_SKINS = [
        ...
        {id:'mine_pulse',slot:'mine',name:'脉冲埋雷',rarity:'common',price:80,desc:'埋雷特效，第二步补动画。'},
        {id:'mine_shadow',slot:'mine',name:'暗影埋雷',rarity:'rare',price:180,desc:'埋雷特效，第二步补动画。'},
        {id:'defuse_scan',slot:'defuse',name:'扫描拆解',rarity:'common',price:80,desc:'拆除特效，第二步补动画。'},
        {id:'defuse_silver',slot:'defuse',name:'银线拆解',rarity:'rare',price:180,desc:'拆除特效，第二步补动画。'}
    ];
    var SHOP_WHISPERS = [
