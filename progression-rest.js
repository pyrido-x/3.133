...
const ProgressionManager = (function(){
    ...
    async function saveToCloud(){
        ...
        var row={
            ...
            daily_game_coins:data.dailyGameCoins,daily_game_coin_date:data.dailyGameCoinDate,email:data.email,
    ...
    return {
        ...
        onGameEnd:function(won){
            data.gamesPlayed++;this.addXP(20);this.awardGameCoins();_onRankedGame(won);
