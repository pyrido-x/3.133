...
var ProgressionManager = (function(){
    ...
    var SHOP_SKINS = [
        ...
        {id:'blast_arc',slot:'blast',name:'电弧轰击',rarity:'rare',price:180,desc:'轰击路径划过明亮电弧。'},
        {id:'blink_trail',slot:'blink',name:'残影闪',rarity:'common',price:80,desc:'闪现时拖出细碎残影。'},
        {id:'blink_leaf',slot:'blink',name:'落叶树闪',rarity:'rare',price:180,desc:'树闪落点卷起叶片。'},
        ...
        {id:'defuse_silver',slot:'defuse',name:'银线拆解',rarity:'rare',price:180,desc:'拆雷时银线切开陷阱。'}
    ];
    var SHOP_WHISPERS = [
...
var Shop={
    ...
    renderStore:function(){
        ...
        var groups=[['cell','纹理'],['blink','闪'],['blast','轰'],['mine','埋雷'],['defuse','拆']];
