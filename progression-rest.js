...
var Shop={
    ...
    renderPreview:function(s){
        ...
        if(s.id==='cell_circuit')return'<div class="'+cls+'"><div class="preview-atlas circuit"></div></div>';
        if(s.id==='cell_ink')return'<div class="'+cls+'"><div class="preview-atlas ink"></div></div>';
        if(s.id==='kill_crown')return'<div class="'+cls+'"><div class="preview-atlas crown"></div></div>';
