...
var SupabaseREST = {
    ...
    nickClaim: async function(name,pid){
        try{var r=await fetch(this.url+'/rest/v1/nicknames',{method:'POST',headers:this._authHeaders(),body:JSON.stringify({nickname:name,player_id:pid})});return r.ok;}catch(e){return false;}
    },
